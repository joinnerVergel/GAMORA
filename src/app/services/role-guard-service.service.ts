...
export class RoleGuardServiceService implements CanActivate {
  ...
  constructor(private logService: LogManagedService, private router: Router, private loginService: LoginService, private dEService: DataEncryptionService) { }
  ...
  async getValueWithAsync() {
    const item = await  this.dEService.getDataEnc();
    this.dEService.content={a:item['dataResult'][0].Campo1,b:item['dataResult'][0].Campo2,c:item['dataResult'][0].Campo3}
  }
