...
@Component({
  selector: 'app-new-davox-brand',
  templateUrl: './new-davox-brand.component.html',
  styleUrls: ['./new-davox-brand.component.css']
})
export class NewDavoxBrandComponent implements OnInit, ComponentCanDeactivate {
  ...
  readBrandsFileList() {
    this.manageBrandsService.getBrandsFileList(4)
      .subscribe(
        item => {
