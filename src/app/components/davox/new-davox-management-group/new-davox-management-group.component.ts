...
@Component({
  selector: 'app-new-davox-management-group',
  templateUrl: './new-davox-management-group.component.html',
  styleUrls: ['./new-davox-management-group.component.css']
})
export class NewDavoxManagementGroupComponent implements OnInit,ComponentCanDeactivate {
  ...
  readItemsBrandsList() {
    this.mGroupsService.getItemsBrandsList(4)
      .subscribe(
        item => {
  ...
  requestQry(){
    ...
    let FiltroGrupo: any={idTipoOperacion:4,NombreGrupo:"",EdadMoraInicial:firstAge,EdadMoraFinal:lastAge,PrioridadBasica:null,ListaFiltros:this.fitersList,tipoTransaccion:101};
  ...
  requestIns(){
    ...
    let FiltroGrupo: any={idTipoOperacion:4,NombreGrupo:this.f.groupName.value,EdadMoraInicial:firstAge,EdadMoraFinal:lastAge,PrioridadBasica:null,ListaFiltros:this.fitersList,tipoTransaccion:1002};
