...
@Component({
  selector: 'app-davox-sub-category-elements-list',
  templateUrl: './davox-sub-category-elements-list.component.html',
  styleUrls: ['./davox-sub-category-elements-list.component.css']
})
export class DavoxSubCategoryElementsListComponent implements OnInit, ComponentCanDeactivate {
  ...
  Validation() {
    ...
    if (!this.newSubCategoryElementForm.invalid) {
      ...
      if (this.ageValidation &&
        (!this.scriptValidation && this.categoryId == 25 || this.scriptValidation) &&
        ((!this.linkValidation && (this.categoryId == 23 || this.categoryId == 25)) || this.linkValidation) &&
        this.contactOptionValidation &&
        ((!this.subjectValidation && (this.categoryId == 22 || this.categoryId == 23 || this.categoryId == 25|| this.categoryId==26)) || this.subjectValidation)) {
        return true;
      }
    }
  ...
  getFathersElement() {
    this.sub = this.route.params.subscribe(params => {
      ...
      if (this.categoryId == 22 || this.categoryId == 23 || this.categoryId == 25 || this.categoryId == 26) {
        this.contactValue = 1;
  ...
  backPage() {
    this.router.navigate(['/events-manager/davox/category/' + this.categorySelected.idCategory])
  }
  ...
  readTagsList() {
    this.eventsService.getTagsListScript("davox")
      .subscribe(
        item => {
