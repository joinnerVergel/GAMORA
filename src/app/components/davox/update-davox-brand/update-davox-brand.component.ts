...
@Component({
  selector: 'app-update-davox-brand',
  templateUrl: './update-davox-brand.component.html',
  styleUrls: ['./update-davox-brand.component.css']
})
export class UpdateDavoxBrandComponent implements OnInit {
