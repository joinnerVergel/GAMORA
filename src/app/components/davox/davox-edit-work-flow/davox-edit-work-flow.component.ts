...
@Component({
  selector: 'app-davox-edit-work-flow',
  templateUrl: './davox-edit-work-flow.component.html',
  styleUrls: ['./davox-edit-work-flow.component.css']
})
export class DavoxEditWorkFlowComponent implements OnInit,ComponentCanDeactivate {
  submitted = false;
  wfParameter:any;
  idWF:number;
  nameWF:string;
  ...
  readNameWF(){
    this.symbolsService.getRefWorkflow(1,this.idWF.toString(),4)
    .subscribe(
      respuesta => {
