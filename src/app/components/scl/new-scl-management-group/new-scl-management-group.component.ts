...
@Component({
  selector: 'app-new-scl-management-group',
  templateUrl: './new-scl-management-group.component.html',
  styleUrls: ['./new-scl-management-group.component.css']
})
export class NewSclManagementGroupComponent implements OnInit,ComponentCanDeactivate {
  ...
  readItemsBrandsList() {
    this.mGroupsService.getItemsBrandsList(3)
      .subscribe(
        item => {
  ...
  requestQry(){
    ...
    let FiltroGrupo: any={idTipoOperacion:3,NombreGrupo:"",EdadMoraInicial:firstAge,EdadMoraFinal:lastAge,PrioridadBasica:null,ListaFiltros:this.fitersList,tipoTransaccion:101};
  ...
  requestIns(){
    ...
    let FiltroGrupo: any={idTipoOperacion:3,NombreGrupo:this.f.groupName.value,EdadMoraInicial:firstAge,EdadMoraFinal:lastAge,PrioridadBasica:null,ListaFiltros:this.fitersList,tipoTransaccion:1002};
