...
@Component({
  selector: 'app-scl-sub-category-elements-list',
  templateUrl: './scl-sub-category-elements-list.component.html',
  styleUrls: ['./scl-sub-category-elements-list.component.css']
})
export class SclSubCategoryElementsListComponent implements OnInit, ComponentCanDeactivate {
  ...
  Validation() {
    ...
    if (!this.newSubCategoryElementForm.invalid) {
      ...
      if (this.ageValidation &&
        (!this.scriptValidation && this.categoryId == 18 || this.scriptValidation) &&
        ((!this.linkValidation && (this.categoryId == 16 || this.categoryId == 18)) || this.linkValidation) &&
        this.contactOptionValidation &&
        ((!this.subjectValidation && (this.categoryId == 15 || this.categoryId == 16 || this.categoryId == 18|| this.categoryId==19)) || this.subjectValidation)) {
        return true;
      }
    }
  ...
  getFathersElement() {
    this.sub = this.route.params.subscribe(params => {
      ...
      if (this.categoryId == 15 || this.categoryId == 16 || this.categoryId == 18 || this.categoryId == 19) {
        this.contactValue = 1;
  ...
  backPage() {
    this.router.navigate(['/events-manager/scl/category/' + this.categorySelected.idCategory])
  }
  ...
  readTagsList() {
    this.eventsService.getTagsListScript("scl")
      .subscribe(
        item => {
