...
@Component({
  selector: 'app-scl-edit-work-flow',
  templateUrl: './scl-edit-work-flow.component.html',
  styleUrls: ['./scl-edit-work-flow.component.css']
})
export class SclEditWorkFlowComponent implements OnInit,ComponentCanDeactivate {
  submitted = false;
  wfParameter:any;
  idWF:number;
  nameWF:string;
  ...
  readNameWF(){
    this.symbolsService.getRefWorkflow(1,this.idWF.toString(),3)
    .subscribe(
      respuesta => {
