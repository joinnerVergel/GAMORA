...
@Component({
  selector: 'app-update-scl-brand',
  templateUrl: './update-scl-brand.component.html',
  styleUrls: ['./update-scl-brand.component.css']
})
export class UpdateSclBrandComponent implements OnInit {
