...
@Component({
  selector: 'app-update-fixed-brand',
  templateUrl: './update-fixed-brand.component.html',
  styleUrls: ['./update-fixed-brand.component.css']
})
export class UpdateFixedBrandComponent implements OnInit {
